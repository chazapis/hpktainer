...
import (
	...
	"hpk/compute/endpoint"
	"hpk/compute/volume/configmap"
	"hpk/compute/volume/emptydir"
	"hpk/compute/volume/hostpath"
	"hpk/compute/volume/projected"
	"hpk/compute/volume/secret"
	"hpk/compute/volume/util"
